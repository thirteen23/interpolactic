...
namespace Interpolactic
{
    public partial class IPInterpolator
    {
        ...
        /**
         * Compile the IPInterpolator into a MEC, from "More Effective Coroutines", a
         ...
         * 
         * \warning To run an IPInterpolator as an MEC in real time, MEC Pro must be purchased
